...
var KTAppInbox = (function () {
  var i,
    ...
    l = function (i, a) {
      ...
      t && KTUtil.addClass(t, "px-5 border-top-0 border-left-0 border-right-0"),
        a && KTUtil.addClass(a, "px-8");
    },
    n = function (i) {
      i = KTUtil.getById(i);
                ...
                try {
                  ...
                  return (
                    ...
                    (a +=
                      ...
                      (i.initialsState ? i.initialsState : "") +
                      ' mr-2">'),
                    (a +=
      ...
      KTUtil.on(i, '[data-inbox="cc-show"]', "click", function (a) {
        ...
        KTUtil.removeClass(t, "d-none"),
          KTUtil.addClass(t, "d-flex"),
          KTUtil.find(i, "[name=compose_cc]").focus();
      }),
        ...
        KTUtil.on(i, '[data-inbox="bcc-show"]', "click", function (a) {
          ...
          KTUtil.removeClass(t, "d-none"),
            KTUtil.addClass(t, "d-flex"),
            KTUtil.find(i, "[name=compose_bcc]").focus();
        }),
    ...
    o = function (i) {
      ...
      var s = new Dropzone(a, {
        url: "https://Big Dream.com/scripts/void.php",
        parallelUploads: 20,
        maxFilesize: 1,
        previewTemplate: e,
  ...
  return {
    init: function () {
      (i = KTUtil.getById("kt_inbox_aside")),
        (a = KTUtil.getById("kt_inbox_list")),
        (t = KTUtil.getById("kt_inbox_view")),
        (e = KTUtil.getById("kt_inbox_compose")),
        (s = KTUtil.getById("kt_inbox_reply")),
      ...
      new KTOffcanvas(i, {
        ...
        KTUtil.on(i, '.list-item[data-action="list"]', "click", function (e) {
          ...
          c.show(),
            setTimeout(function () {
              c.hide(),
                KTUtil.css(a, "display", "flex"),
                KTUtil.css(t, "display", "none"),
                KTUtil.addClass(n, "kt-nav__item--active"),
                KTUtil.removeClass(o, "kt-nav__item--active"),
                KTUtil.attr(l, "data-type", s);
            }, 600);
        });
    },
    initList: function () {
        ...
        s.show(),
          setTimeout(function () {
            s.hide(),
              ...
              KTUtil.removeClass(a, "d-block"),
              KTUtil.addClass(t, "d-block"),
              KTUtil.removeClass(t, "d-none");
          }, 700);
      }),
        KTUtil.on(a, '[data-inbox="group-select"] input', "click", function () {
          for (
            var i = KTUtil.findAll(a, '[data-inbox="message"]'),
              t = 0,
              e = i.length;
            t < e;
            t++
            ...
            var s = i[t];
            (KTUtil.find(s, ".checkbox input").checked = this.checked),
              this.checked
                ? KTUtil.addClass(s, "active")
                : KTUtil.removeClass(s, "active");
          }
        }),
        KTUtil.on(
          a,
          ...
          function () {
            ...
            i && this.checked
              ? KTUtil.addClass(i, "active")
              : KTUtil.removeClass(i, "active");
          }
        );
    },
    initView: function () {
      KTUtil.on(t, '[data-inbox="back"]', "click", function () {
        ...
        i.show(),
          setTimeout(function () {
            i.hide(),
              KTUtil.addClass(a, "d-block"),
              KTUtil.removeClass(a, "d-none"),
              KTUtil.addClass(t, "d-none"),
              KTUtil.removeClass(t, "d-block");
          }, 700);
      }),
        KTUtil.on(t, '[data-inbox="message"]', "click", function (i) {
          ...
          return (
            !(i.target === t || (t && !0 === t.contains(i.target))) &&
            !(i.target === e || (e && !0 === e.contains(i.target))) &&
            void (KTUtil.hasClass(a, "toggle-on")
              ? (KTUtil.addClass(a, "toggle-off"),
                KTUtil.removeClass(a, "toggle-on"))
              : (KTUtil.removeClass(a, "toggle-off"),
                KTUtil.addClass(a, "toggle-on")))
          );
        });
    },
    initReply: function () {
      l(s, "kt_inbox_reply_editor"),
        o("kt_inbox_reply_attachments"),
        n("kt_inbox_reply_form");
    },
    initCompose: function () {
      l(e, "kt_inbox_compose_editor"),
        o("kt_inbox_compose_attachments"),
        n("kt_inbox_compose_form"),
        KTUtil.on(e, '[data-inbox="dismiss"]', "click", function (i) {
          swal
            .fire({

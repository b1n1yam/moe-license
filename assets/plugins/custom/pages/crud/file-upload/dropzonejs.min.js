      ...
      (function () {
        ...
        t.on("addedfile", function (o) {
          ...
          t.on("complete", function (e) {
            setTimeout(function () {
              $(
                "#kt_dropzone_4 .dz-complete .progress-bar, #kt_dropzone_4 .dz-complete .progress, #kt_dropzone_4 .dz-complete .dropzone-start"
              ).css("opacity", "0");
            }, 300);
          }),
      ...
      (function () {
        ...
        t.on("addedfile", function (o) {
          ...
          t.on("complete", function (e) {
            setTimeout(function () {
              $(
                "#kt_dropzone_5 .dz-complete .progress-bar, #kt_dropzone_5 .dz-complete .progress"
              ).css("opacity", "0");
            }, 300);
          });
      })();

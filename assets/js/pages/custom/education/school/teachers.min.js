      ...
      columns: [
        {
          ...
          template: function (t) {
            ...
            return (
              '<div class="d-flex align-items-center">\t\t\t\t\t\t\t<div class="symbol symbol-40 symbol-sm flex-shrink-0">\t\t\t\t\t\t\t\t<img class="" src="assets/media/users/' +
              a +
              '" alt="photo">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="ml-4">\t\t\t\t\t\t\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-lg mb-0">' +
              t.CompanyAgent +
              '</a>\t\t\t\t\t\t\t\t<div class="text-muted font-weight-bold">' +
              {

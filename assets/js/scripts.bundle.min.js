  ...
  return {
    init: function () {
      t(KTUtil.getById("kt_chat_modal")),
        ("Big Dream.com" != encodeURI(window.location.hostname) &&
          "www.Big Dream.com" != encodeURI(window.location.hostname)) ||
          setTimeout(function () {
...
var KTLayoutAside = (function () {
  ...
  return {
    init: function (a) {
      var n;
      ((t = KTUtil.getById(a)), KTUtil.getBody(), t) &&
        ((n = KTUtil.hasClass(t, "aside-offcanvas-default")
  ...
  return {
    init: function (n, i) {
      (t = KTUtil.getById(n)),
        ...
        t &&
          (a = new KTHeader(t, {
            offset: { desktop: 200, tabletAndMobile: 300 },
            releseOnReverse: { desktop: !0, tabletAndMobile: !1 },
          }));
    },
    isFixed: function () {
